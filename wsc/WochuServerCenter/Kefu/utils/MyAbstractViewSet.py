...
# @File : MyAbstractViewSet.py
# @Site : wochu.cn
from Kefu.utils.myauth import JSONWebTokenAuthentication
from rest_framework import viewsets
from Kefu.utils.MyPagination import StandardResultsSetPagination
...
class MyAbstractModelViewSet(viewsets.ModelViewSet):
    '''
    自定义的模型类视图集
    '''
...
class MyAbstractModelViewSet2(MyListModelMixin,
